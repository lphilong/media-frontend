...
const selfServiceKpiFixtureSource = {
  ...
  previous: [
    {
      kpiPlanId: 'kpi-plan-self-org-unit-may-published',
      planCode: 'KPI-SELF-ORG-202605',
      ...
      isReadOnly: true,
      lastUpdatedAt: Date.UTC(2026, 4, 31, 4, 0),
      metrics: [
        {
          metricCode: 'REVENUE_VND',
          unit: 'VND',
          targetValue: 22000000,
          actualValue: 20500000,
    ...
    {
      kpiPlanId: 'kpi-plan-self-org-unit-april-finalized',
      planCode: 'KPI-SELF-ORG-202604',
