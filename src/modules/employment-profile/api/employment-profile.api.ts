...
const employmentProfileListItemSchema = z
  .object({
    ...
    hrOwnerEmploymentProfileRef: referenceSummarySchema.nullable().optional(),
    onboardingOwnerEmploymentProfileId: z.string().trim().min(1).nullable().optional(),
    onboardingOwnerEmploymentProfileRef: referenceSummarySchema.nullable().optional(),
    sourcedByEmploymentProfileId: z.string().trim().min(1).nullable().optional(),
    sourcedByEmploymentProfileRef: referenceSummarySchema.nullable().optional(),
    ...
    hiredAt: utcMidnightDateLikeSchema.nullable().optional(),
    onboardedAt: utcMidnightDateLikeSchema.nullable().optional(),
