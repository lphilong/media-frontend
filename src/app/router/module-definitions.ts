...
export const moduleRouteDefinitions: ModuleRouteDefinition[] = [
  ...
  {
    id: 'responsibility',
    listPath: APP_PATHS.responsibilities,
    namespace: 'responsibility',
    navGroup: 'organization',
    navItemKey: 'responsibilities',
    listTitleKey: 'responsibility:page.title',
    listSubtitleKey: 'responsibility:page.subtitle',
    placeholderKey: 'responsibility:page.placeholder',
  },
  {
    id: 'platform-account',
...
export const shellNavigationGroups: ShellNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'responsibilities',
        moduleId: 'responsibility',
        navItemKey: 'responsibilities',
        to: APP_PATHS.responsibilities,
      },
    ],
  },
  {
